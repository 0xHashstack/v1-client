...
describe("Get l3 interaction function values", () => {
  it("displays the liquidity split", async () => {
    ...
    const loanMarket = "DAI";
    const currentAmount = "1973964060000000000001";
    const tokenA = "USDC";
    const tokenB = "USDT";
    // console.log(typeof jediSwapAbi)
    ...
    // const abi = Object.values(jediSwapAbi);
    const l3Contract = new Contract(jediSwapAbi.abi, l3DiamondAddress, provider);
    // console.log(l3Contract);
