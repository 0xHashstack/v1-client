        ...
        >
          ...
          >
            <HStack justifyContent="space-between" mb="4rem">
              ...
              <Box cursor="pointer" onClick={() => setMetricsCancel(true)}>
                <CancelIcon />
              </Box>
            </HStack>
            ...
            <Box mb="4rem">{/* Insert chart component 1 here */}</Box>
            <Box
              // bgColor="cyan"
              width="100%"
              display="flex"
            ...
            <Box mb="4rem">{/* Insert chart component 2 here */}</Box>
            <Box>{/* Insert chart component 3 here */}</Box>
          </Box>
        </Box>
      )}
    </PageCard>
