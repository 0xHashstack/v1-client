...
const Dashboard = () => {
                    ...
                    >
                      <button
                        ...
                        onClick={() => {
                          ...
                          setIsDropDownOpenTypeOfLoans(!isDropDownOpenTypeOfLoans);
                        }}
  ...
  return (
    ...
    >
      ...
      <ToastModal textToCopy="Copy Me" success={true} heading="Transaction Complete" desc="Copy Transaction Hash" />
      {/* // </React.Fragment> */}
    </div>
  );
};
