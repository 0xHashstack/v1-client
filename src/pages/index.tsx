...
const Dashboard = () => {
  ...
  function parseLoansData(loansData: any, collateralsData: any) {
    ...
    for (let i = 0; i < loansData?.length; ++i) {
      ...
      let temp_len = {
        ...
        l3App:
          BNtoNum(loanData?.l3_integration, 0).toString() ===
  ...
  useEffect(() => {
    ...
    !isTransactionDone && account
      ? parseLoansData(
          dataLoan?.loan_records_arr,
          dataLoan?.collateral_records_arr
        )
      : null;
  }, [
    account,
  ...
  useEffect(() => {
    ...
    !isTransactionDone && account && !loadingDeposit
      ? parseDepositsData(dataDeposit?.deposit_records_arr)
      : null;
  }, [
    account,
    passbookStatus,
