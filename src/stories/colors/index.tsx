...
export const Colors = () => {
  ...
  return (
    <Box display="flex" flexDirection="column" gap="1rem">
      <Box display="flex" flexDirection="column" gap="1rem">
        <Text color="#fff">Core Brand Colors</Text>
