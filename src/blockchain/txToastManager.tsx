...
export class TxToastManager {
    ...
    static handleTxToast(receipt: UseTransactionReceiptResult, purpose: string, onlyL2Confirm=true) {
        ...
        console.log('handleTxToast', {
            hash, hasToast, data: receipt.data
        })
    ...
    static _showToast(hash: string, existingId: {id: Id, stage: Status}, message: ReactNode | string, type: TypeOptions, status: Status, timeout=5000, progress=1) {
        console.log('_showToast', {
            hash, existingId, message, type, status
        })
