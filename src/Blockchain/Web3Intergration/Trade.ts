...
async function tradeEstimateFee(asset:any,amount:any,collateral_market:any,collateral_amount:any,recipient:any,integration:any,loan_id:any,to_market:any) {
  ...
  try {
    ...
    const { suggestedMaxFee: estimatedFee2 } = await account0.estimateInvokeFee({
      contractAddress: opencore_address,
      entrypoint: "integration_swap",
      calldata:[
        integration,
    ...
    const estimatedFee = estimatedFee1 + estimatedFee2;
