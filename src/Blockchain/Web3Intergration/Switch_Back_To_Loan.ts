...
async function Revert_Interact_With_l3_Integration(loan_id:any) {
...
async function Estimate_fee_Revert_Interact_With_l3_Integration(loan_id:any) {
    ...
    try {
        const { suggestedMaxFee: estimatedFee1 } = await account0.estimateInvokeFee({
            ...
            entrypoint: "revert_interact_with_l3",
            calldata:[
                loan_id,
          ],
          });
...
async function get_usd_value_Integration(loan_id:any) {
