								...
								{userSocialsData.length > 0 && (
									<Card
										...
										<Box
											...
											{extractMediumUsernames(
												userSocialsData
											).length > 0 && (
												<RegisteredMediumIcon />
											)}
											{extractTwitterUsernames(
												userSocialsData
											).length > 0 && (
												<RegisteredTwitterIcon />
											)}
											{extractRedditUsernames(
												userSocialsData
											).length > 0 && (
