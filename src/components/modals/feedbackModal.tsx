...
const FeedbackModal = ({
	...
	const [descriptionRatingFeedback, setdescriptionRatingFeedback] =
		useState('');
	const [ratingFeedbackSubmitted, setRatingFeedbackSubmitted] =
		useState(false);
	...
	const handleBugFeedback = async () => {
		...
		axios
			.post(`${process.env.NEXT_PUBLIC_FEEDBACK_API}/api/feedback/bug`, {
				address: address,
								...
								<Box>
									<Box
										...
										onClick={() => {
											...
											posthog.capture(
												'Feedback Modal Rating Feature selected',
												{
													Clicked: true,
												}
											);
									...
									<Box
										...
										onClick={() => {
											...
											posthog.capture(
												'Feedback Modal Report Issue Feature selected',
												{
													Clicked: true,
												}
											);
									...
									<Box
										...
										onClick={() => {
											...
											posthog.capture(
												'Feedback Modal Suggestion Feature selected',
												{
													Clicked: true,
												}
											);
                          ...
                          <CaptureBugIcon/>
										...
										<Box textAlign='center'>
											<Button
												...
												onClick={() => {
													setsuggestionFeedbackSubmitted(
														true
													);
													if (
														!suggestionFeedbackSubmitted
