		...
		setwalletBalance(
			(
				...
				parseAmount(
					String(
						uint256.uint256ToBN(
							walletBalances[currentSelectedSupplyCoin]
		...
		try {
			if (ischecked) {
				...
				if (addSupplyAndStake?.transaction_hash) {
					...
					const trans_data = {
						transaction_hash:
							addSupplyAndStake?.transaction_hash.toString(),
				...
				if (addSupply?.transaction_hash) {
					...
					const trans_data = {
						transaction_hash:
							addSupply?.transaction_hash.toString(),
                          ...
                          <Text color="#676D9A">1.240 rETH</Text>
											...
											<Box
												...
												<Box
													...
													Please unstake the staked
													funds before proceeding with
													the withdrawal.
												</Box>
											</Box>
													...
													<AnimatedButton
														...
														labelSuccessArray={[
															...
															<Text
																...
																{currentSelectedWithdrawlCoin.slice(
																	1
																)}
															</Text>,
															<Text
