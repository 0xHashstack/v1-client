						...
						<ModalBody>
							<Card
								...
								<Box
									...
									onClick={() =>
										handleDropdownClick(
											'supplyEquivalentMarketDropDown'
										)
									}>
									<Box
										display='flex'
								...
								<Box
									...
									border={`${
										inputAmount > walletBalance ?
											'1px solid #CF222E'
										: inputAmount < 0 ? '1px solid #CF222E'
										: isNaN(inputAmount) ?
											'1px solid #CF222E'
										: (
											inputAmount > 0 &&
									...
									<NumberInput
										...
										<NumberInputField
											...
											color={`${
												inputAmount > walletBalance ?
													'#CF222E'
												: isNaN(inputAmount) ? '#CF222E'
												: inputAmount < 0 ? '#CF222E'
												: inputAmount == 0 ? 'white'
												: '#1A7F37'
											}`}
											border='0px'
							...
							<Checkbox
								...
								<Text
									...
									fontWeight='400'
									lineHeight='20px'>
									Ticking would stake the received rTokens
									unchecking wouldn&apos;t stake rTokens
								</Text>
							</Checkbox>
