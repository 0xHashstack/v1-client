...
const TransferDepositModal = ({ buttonText, ...restProps }: any) => {
	...
	const [currentBorrowMarketCoin, setCurrentBorrowMarketCoin] =
		useState('BTC');
	const { writeAsyncZklendMigrate, errorZklendMigrate } = useZklendMigrate();
	...
	const columnItems = ['Market', 'Dapp', 'Current yield', 'Hashstack yield'];
						...
						<ModalBody>
							<Box
								...
								<Text
									...
									fontStyle='normal'
									fontWeight='400'>
									You currently have active deposits on Dapp
									1, Dapp 2, Dapp 3 equating to USD $ XXXX in
									cumulative value, earning a cumulative of x%
									in supply apr. When you migrate these
									deposits to Hashstack, you earn y% more
									yield on your supply and an additional 10%
									of supply apr as bonus. That’s not all,
									Hashstack will reward you x USDT. This will
									be deposited on your behalf into the
									protocol. Terms & conditions apply.
								</Text>
							</Box>
							<Box
								width='99%'
