...
import { selectInputSupplyAmount, selectCoinSelectedSupplyModal, setCoinSelectedSupplyModal, selectWalletBalance, setInputSupplyAmount } from "@/store/slices/userAccountSlice";
                    ...
                    >
                        ...
                        <ModalBody>
                            ...
                            <Card bg="#101216" mt="1rem" p="1rem" border="1px solid #2B2F35">
                                <Text display="flex" justifyContent="space-between" fontSize="0.9rem" mb="0.4rem">
                                    <Text display="flex" alignItems="center" >
                                        <Text mr="0.2rem" font-style="normal"
                                            font-weight="400"
                            ...
                            {inputAmount1 > 0 ?
                                <Button bg="#8B949E" color="white" size='sm' width="100%" mt="2rem" mb="2rem" border="1px solid #2B2F35" _hover={{ bg: "#2DA44E" }} _focus={{ bg: "#298E46" }}>
                                    Supply
                                </Button> :
                                <Button bg="#101216" color="#6E7681" size='sm' width="100%" mt="2rem" mb="2rem" border="1px solid #2B2F35" _hover={{ bg: "#101216" }} >
                                    Supply
                                </Button>
                            }
                        </ModalBody>
