                    ...
                    >
                        ...
                        <ModalBody>
                            ...
                            <Card bg="#101216" mb="0.5rem" p="1.5rem" border="1px solid #6E7681" >
                                ...
                                <Button mb="1rem" mt="0.5rem" bg="none" display="flex" justifyContent="space-between" border="1px solid #2B2F35">
                                ...
                                <Slider defaultValue={0} onChange={(val) => setSliderValue(val)} mt="3rem">
                                    <SliderMark
                                        value={sliderValue}
                                        textAlign='center'
                                        bg='white'
                            ...
                            <Checkbox defaultChecked mt="1rem">
                                <Text fontSize="0.65rem" >
                                    Ticking would stake the received rTokens unchecking wouldnt stake rTokens
                                </Text>
                            </Checkbox>

                            <Card bg="#101216" mt="3rem" p="1rem" border="1px solid #6E7681">
