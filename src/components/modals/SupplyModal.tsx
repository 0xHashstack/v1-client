                        ...
                        <ModalBody>
                            ...
                            <Card bg="#101216" mb="0.5rem" p="1.5rem" border="1px solid #6E7681" >
                                ...
                                <Box width="100%" color="white" border="1px solid #2B2F35" borderRadius="6px" display="flex" justifyContent="space-between">
                                    ...
                                    <Button variant="ghost" color="#0969DA" _hover={{ bg: "#101216" }} onClick={() => { setinputAmount(walletBalance) }}>
                                        MAX
                                    </Button>
                                </Box>
                            ...
                            <Button bg="#101216" color="#6E7681" size='sm' width="100%" mt="2rem" mb="2rem" border="1px solid #6E7681" _hover={{ bg: "#101216" }} >
                                Supply
                            </Button>
                        </ModalBody>
                    </ModalContent>
