...
const StakeUnstakeModal = ({
  ...
  }, [currentSelectedStakeCoin, minAmounts])
  useEffect(() => {
                  ...
                  <TabPanels>
                    <TabPanel p="0" m="0">
                      ...
                      >
                        ...
                        rTokenAmount < 0 || (process.env.NEXT_PUBLIC_NODE_ENV == "mainnet"&& rtokenWalletBalance==0 && rTokenAmount>0 && rTokenAmount<minimumDepositAmount) ? (
                          <Text
                            display="flex"
                            justifyContent="space-between"
                            color="#E6EDF3"
                      ...
                      ) :  rTokenAmount > 0  && rTokenAmount <= walletBalance && (process.env.NEXT_PUBLIC_NODE_ENV == "mainnet" ?rtokenWalletBalance==0  && rTokenAmount>minimumDepositAmount:true) ? (
                        buttonId == 1 ? (
                          <SuccessButton successText="Stake success" />
                        ) : buttonId == 2 ? (
                          <ErrorButton errorText="Copy error!" />
