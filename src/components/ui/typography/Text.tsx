...
const paragraphVariants = cva('text-text-primary-700', {
	variants: {
		...
		textColor: {
			'light-green': 'text-app-light-green',
			'dark-blue': 'text-app-dark-blue',
			'light-gray': 'text-app-light-gray',
			'mid-gray': 'text-app-mid-gray',
			'dark-gray': 'text-app-dark-gray',
			'light-blue': 'text-app-light-blue',
			'light-blue-alt': 'text-app-light-blue-alt',
			'mid-blue': 'text-app-mid-blue',
			'dark-blue-alt': 'text-app-dark-blue-alt',
			'dark-gray-alt': 'text-app-dark-gray-alt',
			'light-gray-alt': 'text-app-light-gray-alt',
			'dark-gray-alt2': 'text-app-dark-gray-alt2',
