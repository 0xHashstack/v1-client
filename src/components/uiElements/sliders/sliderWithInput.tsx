...
import { selectInputSupplyAmount, selectWalletBalance, setInputSupplyAmount ,selectCoinSelectedSupplyModal} from "@/store/slices/userAccountSlice";
  ...
  return (
    <Box>
      <Box width="100%" color="white" border="1px solid #2B2F35" borderRadius="6px" display="flex" justifyContent="space-between">
        <NumberInput border="0px" min={0} keepWithinRange={true} onChange={handleChange} value={inputAmount}
        >
      ...
      <Text color="#E6EDF3" display="flex" justifyContent="flex-end" mt="0.4rem">
