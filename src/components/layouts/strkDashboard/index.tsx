import { Box, Button, HStack, Skeleton, Table, TableContainer, Tbody, Td, Text, Thead, Tooltip, Tr, VStack } from '@chakra-ui/react'
import React, { useEffect, useState } from 'react'
import PageCard from '../pageCard'
import numberFormatter from '@/utils/functions/numberFormatter'
import InfoIcon from '@/assets/icons/infoIcon'
import { useDispatch, useSelector } from 'react-redux'
import { selectModalDropDowns, selectNavDropdowns, setModalDropdown, setNavDropdown } from '@/store/slices/dropdownsSlice'
...
import { selectOraclePrices, selectProtocolStats, selectEffectiveApr, selectHealthFactor, selectUserDeposits } from '@/store/slices/readDataSlice'
