  ...
  return (
    <Box display="flex" gap="30px">
        <Box display="flex" flexDirection="column" gap="8px">
            <Box display="flex" flexDirection="column" alignItems="flex-start" width="1478px"  border="1px solid #2B2F35" color="#E6EDF3" padding="24px 24px 16px" fontSize="20px" fontStyle="normal" fontWeight="600" lineHeight="30px" borderRadius="6px">
                Risk Premium:
            </Box>
                <RiskPremiumChart/>
        </Box>
