			...
			setcollateralMarkets(
				Borrows.sort(
					(
						...
						const isCollateralA =
							a.collateralCoin === maxSuppliedCoin;
						const isCollateralB =
							b.collateralCoin === maxSuppliedCoin;
			...
			if (tokenSelection[selectedIndex ? selectedIndex : 0] != 1) {
				...
				if (borrowAndSpend?.transaction_hash) {
					...
					posthog.capture('Degen Spend Successfully', {
						...
						CollateralAmount:
							rTokenAmount != 0 ? rTokenAmount : collateralAmount,
						transaction_hash:
							borrowAndSpend?.transaction_hash.toString(),
					});
						...
						<Tbody
							...
							{Borrows.sort(
								(
									...
									// Sorting based on collateral
									const isCollateralA =
										a.collateral === maxSuppliedCoin;
									const isCollateralB =
										b.collateral === maxSuppliedCoin;
